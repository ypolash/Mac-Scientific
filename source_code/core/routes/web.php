...
Route::group(['middleware' => 'adminlocalize'], function () {
    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::group(['middleware' => 'permissions:Manage Products'], function () {
            ...
            Route::post('item/video/upload', 'Back\ItemController@uploadVideo')->name('back.item.uploadVideo');
            ...
            Route::post('item/gallery/sort', 'Back\ItemController@gallerySort')->name('back.item.gallery.sort');
